...
const doorAmbientOcculusionTexture = textureLoader.load('/textures/door/ambientOcculsion.jpg');
...
const roof = new THREE.Mesh(
    new THREE.ConeGeometry(3.5, 1.6, 4),
...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: doorAmbientOcculusionTexture, displacementMap: doorHeightTexture, displacementScale:0.1,
...
const tick = () =>
{
    ...
    ghost3.position.y = Math.sin(elapsedTime*8)
    // Update controls
    controls.update()
